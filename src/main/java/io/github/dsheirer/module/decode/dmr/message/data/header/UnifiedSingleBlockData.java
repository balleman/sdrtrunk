 ...
 */
public class UnifiedSingleBlockData extends DataMessage
{
     ...
     */
    public UnifiedSingleBlockData(DMRSyncPattern syncPattern, CorrectedBinaryMessage message, CACH cach, SlotType slotType, long timestamp, int timeslot)
    {
