...
public class CapacityPlusSystemStatus extends CSBKMessage implements ITimeslotFrequencyReceiver
{
    ...
    private static final int[] REST_CHANNEL = new int[]{19, 20, 21, 22, 23};

    private DMRTimeslotFrequencyChannel mRestChannel;
     ...
     */
    public DMRTimeslotFrequencyChannel getRestChannel()
    {
        if(mRestChannel == null)
        {
            mRestChannel = new DMRTimeslotFrequencyChannel(getMessage().getInt(REST_CHANNEL));
        }
